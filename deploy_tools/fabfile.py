...
def _add_cronjobs():
    ...
    run('echo "0 0 4 9-12 3 cd ~/sites/fredandfred.tk && ./virtualenv/bin/python set_currentweek_reminder_emails.py" >> /tmp/crondump')
    run('echo "0 0 * * 1 cd ~/sites/fredandfred.tk && ./virtualenv/bin/python send_backup_email.py" >> /tmp/crondump')
